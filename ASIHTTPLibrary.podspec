...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of ASIHTTPLibrary.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/supron.sust@gmail.com/ASIHTTPLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'supron.sust@gmail.com' => 'supron.sust@gmail.com' }
  s.source           = { :git => 'https://github.com/supron.sust@gmail.com/ASIHTTPLibrary.git', :tag => s.version.to_s }
