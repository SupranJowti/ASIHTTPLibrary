...
@interface ASIHTTPRequest : NSOperation <NSCopying> {
	...
	BOOL downloadDataHearderEncryptEnable;
...
// Called unconditional when we get a content-length header and shouldResetDownloadProgress is true,
...
@property (assign) BOOL downloadDataHearderEncryptEnable;
@property (retain) NSString* EncryptKeyString;
